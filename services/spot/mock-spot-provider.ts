...
const SPOT_TEMPLATES: SpotTemplate[] = [
  ...
  },
  {
    ...
    name: 'サンプル風待ちデッキ',
    category: '休憩',
    description: '車を停めてひと息つく場面を想定した、実在しない休憩ポイントです。',
    recommendation: '運転の合間に無理なく休憩を入れられる位置を想定しています。',
    extraMinutes: 4,
    extraDistanceKm: 0.5,
    bearing: 170,
    offsetKm: 0.2,
  },
  {
    ...
    name: 'サンプルひみつの小径',
    category: '穴場',
    description: '偶然見つける楽しさを表現するための、架空の立ち寄りスポットです。',
    recommendation: '予定調和ではない小さな発見をルートへ加えられます。',
    extraMinutes: 6,
    extraDistanceKm: 0.8,
    bearing: -135,
    offsetKm: 0.24,
